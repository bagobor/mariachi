...
*/
void ByteUtil::decode(unsigned int *output, const unsigned char *input, unsigned int size) {
...
* @param size The size of the input buffer (in bytes).
*/
void ByteUtil::encode(unsigned char *output, const unsigned int *input, unsigned int size) {
    for(unsigned int i = 0, j = 0; j < size; i++, j += 4) {
